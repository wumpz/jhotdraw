...
public class Bounds implements Serializable {
  ...
  public Bounds(Point2D centerPoint2D, double dWidth,
   double dHeight) {
  ...
  public void setCenter(Point2D centerPoint2D) {
    ...
    double dDeltaX = centerPoint2D.getX()
     - currentCenterPoint2D.getX();
    double dDeltaY = centerPoint2D.getY()
     - currentCenterPoint2D.getY();
  ...
  public Point2D getCenter() {
    ...
    return new Point2D.Double((_dX1 + _dX2) / 2.0,
     (_dY1 + _dY2) / 2.0);
  ...
  public void includeLine(double x1, double y1, double x2,
   double y2) {
  ...
  public boolean intersectsLine(Point2D onePoint2D,
   Point2D twoPoint2D) {
  ...
  public boolean completelyContainsLine(double x1, double y1,
   double x2, double y2) {
  ...
  public Point2D[] cropLine(double x1, double y1, double x2,
   double y2) {
    ...
    if (beginPoint2D.getX() == endPoint2D.getX()) {
      ...
      if (!intersectsPoint(beginPoint2D)) {
        if (beginPoint2D.getY() > _dY2) {
          double x = ((_dY2 - beginPoint2D.getY()) / dSlope)
           + beginPoint2D.getX();
          if ((x >= _dX1) && (x <= _dX2)) {
        ...
        if (beginPoint2D.getY() < _dY1) {
          double x = ((_dY1 - beginPoint2D.getY()) / dSlope)
           + beginPoint2D.getX();
          if ((x >= _dX1) && (x <= _dX2)) {
            beginPoint2D.setLocation(x, beginPoint2D.getY());
            beginPoint2D.setLocation(beginPoint2D.getX(), _dY1);
        ...
        if (beginPoint2D.getX() > _dX2) {
          double y = dSlope*(_dX2 - beginPoint2D.getX())
           + beginPoint2D.getY();
          if ((y >= _dY1) && (y <= _dY2)) {
            beginPoint2D.setLocation(_dX2, beginPoint2D.getY());
        ...
        if (beginPoint2D.getX() < _dX1) {
          double y = dSlope*(_dX1 - beginPoint2D.getX())
           + beginPoint2D.getY();
          if ((y >= _dY1) && (y <= _dY2)) {
            beginPoint2D.setLocation(_dX1, beginPoint2D.getY());
            beginPoint2D.setLocation(beginPoint2D.getX(), y);
