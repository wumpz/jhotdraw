 ...
 *
 * <p>The base class loads and saves drawings asynchronously and handles errors. The actual data
 * transmission and the editing of drawings is the responsibility of the subclasses.
 *
 * <p>FIXME - Applet must offer to save file locally, if uploading to server failed.
 *
 * <p>FIXME - Applet must save changes locally and reload them, if the user navigated out of the
 * page and back again, without saving the changes.
 *
...
public class SVGApplet extends JApplet {
  ...
  public SVGApplet() {
    ...
    ((JComponent) getContentPane())
        .setBorder(new MatteBorder(new Insets(1, 1, 1, 1), new Color(0xa5a5a5)));
    // ResourceBundleUtil.setVerbose(true);
  }

  /**
   * Same as <code>Applet.getParameter()</code> but doesn't throw a NullPointerException when used
      ...
      protected void failed(Throwable result) {
        ...
        MessagePanel mp =
            new MessagePanel(
                ...
                labels.getFormatted(
                    "messageLoadFailed",
                    htmlencode(getParameter("DrawingURL")),
                    htmlencode(message)));
        c.add(mp);
