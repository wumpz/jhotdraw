...
public class HandleAttributeKeys {
  ...
  public static final AttributeKey<Color> BEZIER_NODE_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("bezierControlPointStrokeColor", Color.class, Color.WHITE);
  /** Bezier node handle fill color. */
  public static final AttributeKey<Color> BEZIER_NODE_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("bezierControlPointFillColor", Color.class, new Color(0x00a8ff));
  /** Bezier path stroke color 1. */
  public static final AttributeKey<Color> BEZIER_PATH_COLOR_1 =
      new AttributeKey<Color>("bezierPathColor1", Color.class, Color.WHITE);
  /** Bezier path stroke color 2. */
  public static final AttributeKey<Color> BEZIER_PATH_COLOR_2 =
      new AttributeKey<Color>("bezierPathColor2", Color.class, new Color(0x00a8ff));
  ...
  public static final AttributeKey<Color> BEZIER_TANGENT_COLOR_1_DISABLED =
      new AttributeKey<Color>("bezierTangentColor1Disabled", Color.class, STROKE_COLOR_DISABLED);
  /** Bezier tangent line stroke color 2. */
  public static final AttributeKey<Color> BEZIER_TANGENT_COLOR_2_DISABLED =
      new AttributeKey<Color>("bezierTangentColor1Disabled", Color.class, FILL_COLOR_DISABLED);
  /** Bezier tangent line stroke 1. */
  ...
  public static final AttributeKey<Color> BEZIER_NODE_HANDLE_FILL_COLOR_DISABLED =
      new AttributeKey<Color>(
          "bezierControlPointFillColorDisabled", Color.class, FILL_COLOR_DISABLED);
  /** Bezier path stroke color 1. */
  public static final AttributeKey<Color> BEZIER_PATH_COLOR_1_DISABLED =
      new AttributeKey<Color>("bezierPathColor1Disabled", Color.class, Color.WHITE);
  /** Bezier path stroke color 2. */
  public static final AttributeKey<Color> BEZIER_PATH_COLOR_2_DISABLED =
      new AttributeKey<Color>("bezierPathColor2Disabled", Color.class, new Color(0x0));
  /** Bezier path stroke 1. */
  ...
  public static final AttributeKey<Color> TRANSFORM_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("transformHandleStrokeColor", Color.class, Color.WHITE);
  /** Transform handle fill color. */
  public static final AttributeKey<Color> TRANSFORM_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("transformHandleFillColor", Color.class, Color.MAGENTA);
  // ---
  /** Transform handle stroke color. */
  public static final AttributeKey<Color> TRANSFORM_HANDLE_STROKE_COLOR_DISABLED =
      new AttributeKey<Color>(
          "transformHandleStrokeColorDisabled", Color.class, STROKE_COLOR_DISABLED);
  /** Transform handle fill color. */
  public static final AttributeKey<Color> TRANSFORM_HANDLE_FILL_COLOR_DISABLED =
      new AttributeKey<Color>("transformHandleFillColorDisabled", Color.class, FILL_COLOR_DISABLED);
  /** Transform bounds color 1. */
  public static final AttributeKey<Color> TRANSFORM_BOUNDS_COLOR_1 =
      new AttributeKey<Color>("transformBoundsColor1", Color.class, Color.WHITE);
  /** Transform bounds color 2. */
  public static final AttributeKey<Color> TRANSFORM_BOUNDS_COLOR_2 =
      new AttributeKey<Color>("transformBoundsColor2", Color.class, Color.MAGENTA);
  ...
  public static final AttributeKey<Color> CONNECTED_CONNECTION_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("connectedConnectionHandleStrokeColor", Color.class, Color.BLACK);
  /** Handle fill color. */
  public static final AttributeKey<Color> CONNECTED_CONNECTION_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("connectedConnectionHandleFillColor", Color.class, Color.GREEN);
  /** Handle stroke color. */
  public static final AttributeKey<Color> DISCONNECTED_CONNECTION_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("disconnectedConnectionHandleStrokeColor", Color.class, Color.BLACK);
  /** Handle fill color. */
  public static final AttributeKey<Color> DISCONNECTED_CONNECTION_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("disconnectedConnectionHandleFillColor", Color.class, Color.RED);
  /** Handle stroke color. */
  public static final AttributeKey<Color> CONNECTED_CONNECTOR_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("connectedConnectorHandleStrokeColor", Color.class, Color.BLACK);
  /** Handle fill color. */
  public static final AttributeKey<Color> CONNECTED_CONNECTOR_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("connectedConnectorHandleFillColor", Color.class, Color.GREEN);
  /** Handle stroke color. */
  public static final AttributeKey<Color> DISCONNECTED_CONNECTOR_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("disconnectedConnectorHandleStrokeColor", Color.class, Color.BLACK);
  /** Handle fill color. */
  public static final AttributeKey<Color> DISCONNECTED_CONNECTOR_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("disconnectedConnectorHandleFillColor", Color.class, Color.RED);
  /** Handle stroke color. */
  public static final AttributeKey<Color> MOVE_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("moveHandleStrokeColor", Color.class, Color.BLACK);
  /** Handle fill color. */
  public static final AttributeKey<Color> MOVE_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("moveHandleFillColor", Color.class, Color.WHITE);
  /** Handle stroke color. */
  public static final AttributeKey<Color> NULL_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("nullHandleStrokeColor", Color.class, Color.DARK_GRAY);
  /** Handle fill color. */
  public static final AttributeKey<Color> NULL_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("nullHandleFillColor", Color.class, null);
  /** Handle stroke color. */
  public static final AttributeKey<Color> OVERFLOW_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("overlfowHandleStrokeColor", Color.class, Color.RED);
  /** Handle fill color. */
  public static final AttributeKey<Color> OVERFLOW_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("overflowHandleFillColor", Color.class, null);
  // --
  /** Attribute handle stroke color. */
  public static final AttributeKey<Color> ATTRIBUTE_HANDLE_STROKE_COLOR =
      new AttributeKey<Color>("attributeHandleStrokeColor", Color.class, Color.BLACK);
  /** Attribute handle fill color. */
  public static final AttributeKey<Color> ATTRIBUTE_HANDLE_FILL_COLOR =
      new AttributeKey<Color>("attributeSizeHandleFillColor", Color.class, Color.YELLOW);
  // --
  /** Attribute handle stroke color. */
  public static final AttributeKey<Color> ATTRIBUTE_HANDLE_STROKE_COLOR_DISABLED =
      new AttributeKey<Color>(
          "attributeHandleStrokeColorDisabled", Color.class, STROKE_COLOR_DISABLED);
  /** Attribute handle fill color. */
  public static final AttributeKey<Color> ATTRIBUTE_HANDLE_FILL_COLOR_DISABLED =
      new AttributeKey<Color>(
          "attributeSizeHandleFillColorDisabled", Color.class, FILL_COLOR_DISABLED);
}
