/*
 * @(#)GridSettingsPanel.java  1.0  July 31, 2007
 *
...
/**
 * The GridSettingsPanel can be used to edit the grid height and grid width of
 * a GridConstrainer.
 *
 * @author Werner Randelshofer
 * @version 1.0 July 31, 2007 Created.
 */
public class GridSettingsPanel extends javax.swing.JPanel {
    private ResourceBundleUtil labels;
    private GridConstrainer constrainer;
    
    /** Creates new instance. */
    public GridSettingsPanel() {
        labels = ResourceBundleUtil.getLAFBundle("org.jhotdraw.samples.svg.Labels");
        initComponents();
    ...
    public static void main(String[] args) {
        ...
        f.getContentPane().add(new GridSettingsPanel());
        f.pack();
        f.show();
    }
    ...
    private void initComponents() {
        ...
        widthLabel.setText(labels.getString("gridWidth"));

        heightLabel.setText(labels.getString("gridHeight"));
