 ...
 */
public class OSXOpenApplicationAction extends AbstractApplicationAction {

    public final static String ID = "application.openApplication";
    /** Creates a new instance. */
    public OSXOpenApplicationAction(Application app) {
        super(app);
    ...
    public void actionPerformed(ActionEvent e) {
        System.out.println("OSXOpenAction performed");
    }
