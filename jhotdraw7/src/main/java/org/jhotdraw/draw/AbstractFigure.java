...
public abstract class AbstractFigure implements Figure {
	 ...
	 * @see #willChange
	 */
	private transient FigureListener fListener;
	 ...
	 * any kind of FigureListener. A figure is not restricted
	 * to have a single container.
	 */
	public void addToContainer(FigureListener c) {
	 ...
	 */
	public synchronized void addFigureChangeListener(FigureListener l) {
	 ...
	 */
	public synchronized void removeFigureChangeListener(FigureListener l) {
	 ...
	 */
	public synchronized FigureListener listener() {
		return fListener;
	}
	...
	public void release() {
		if (listener() != null) {
			listener().figureRemoved(new FigureEvent(this));
		}
	}
	...
	public void invalidate() {
		if (listener() != null) {
			...
			listener().figureInvalidated(new FigureEvent(this, r));
		}
	}
	...
	public void visit(FigureVisitor visitor) {
		...
		//FigureListener originalListener = listener();
