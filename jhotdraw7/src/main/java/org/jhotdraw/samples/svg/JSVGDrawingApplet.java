/*
 * @(#)JSVGDrawingApplet.java  1.0  2007-06-03
 *
...
/**
 * JSVGDrawingApplet is a simple SVG drawing applet which retrieves an
 * SVG drawing from a web-server using HTTP GET and saves it using an HTTP POST
 * request. The details of the request can be specified using applet parameters.
 *
 * @author Werner Randelshofer
 * @version 1.0 2007-06-03 Created.
 */
public class JSVGDrawingApplet extends AbstractSVGDrawingApplet {
    public JSVGDrawingApplet() {
        setName(MessageFormat.format(
                "JSVGDrawingApplet {0}", getVersion()
                ));
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                JSVGDrawingApplet applet = new JSVGDrawingApplet();
    ...
    @Override protected DrawingComponent createDrawingComponent() {
        return new JSVGDrawingAppletPanel();
    }
    @Override protected JSVGDrawingAppletPanel getDrawingComponent() {
        return (JSVGDrawingAppletPanel) super.getDrawingComponent();
    }
