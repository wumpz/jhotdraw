/*
 * @(#)AbstractSVGDrawingApplet.java  1.1  2008-05-22
 *
...
import org.jhotdraw.samples.svg.io.BoundedRangeInputStream;
 ...
 */
public abstract class AbstractSVGDrawingApplet extends JApplet {
    ...
    public AbstractSVGDrawingApplet() {
    ...
    public String getVersion() {
        if (version == null) {
            ...
            try {
                InputStream resource = AbstractSVGDrawingApplet.class.getResourceAsStream("version.txt");
    ...
    public String getAppletInfo() {
        return getName() +
                "\nVersion " + getVersion() +
                "\n\nCopyright (c) by the authors of JHotDraw.org" +
